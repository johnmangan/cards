#ifndef QUERY_INTERFACE_IMPL_H_
#define QUERY_INTERFACE_IMPL_H_
...
class IQueryImpl : public IQuery
{
public:
    ...
    getFilepaths( std::map< std::string, int > metadataWeights, double percent = 1.0 );
